...
class CurrentProjects {
  ...
  def currentProjects(): Seq[Project] = {
    Seq(
      Project(
        title       = "Skell's Quest",
        description = "A 3D RPG that I'm working on over a long period of time. Every so often I tend to get a new build out, depending on the complexity of the build. Latest build full of UI and Performance fixes, as well as achievements and quality of life features.",
