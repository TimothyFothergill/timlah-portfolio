...
class WalkAboutWithMeConnector @Inject()(implicit val ec: ExecutionContext) {
  def getAllWalkAboutWithMeData: Future[Seq[WalkAboutWithMe]] = {
    val r: Response = requests.get("http://walk-about-with-me-api.herokuapp.com/?marker1lat=44.812031&marker1long=142.074650&marker2lat=43.763066969072504&marker2long=142.35892064504907")
