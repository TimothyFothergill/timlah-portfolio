...
import com.timlah.models.components.button.Icon.default

case class ButtonIcon(
    icon: Option[Icon] = None,
    additionalClasses: String = ""
)

object ButtonIcon {
  implicit val default: ButtonIcon = ButtonIcon()
}

sealed trait Icon {
  def asString: String = default.asString
  def asIcon: Html     = default.asIcon
}
object Icon {
  implicit val default: Icon = Icon.EmailIcon

  case object EmailIcon extends Icon {
    override def asString: String = "email"
    override def asIcon: Html     = Html("""
  ...
  case object SearchIcon extends Icon {
    override def asString: String = "search"
    override def asIcon: Html     = Html("""
  ...
  case object PlayIcon extends Icon {
    override def asString: String = "Play"
    override def asIcon: Html     = Html("""
  ...
  case object PauseIcon extends Icon {
    override def asString: String = "Pause"
    override def asIcon: Html     = Html("""
