...
object EnquiryType {
  case object BusinessEnquiry extends EnquiryType {
    override val asString = "Business Enquiry"
  }
  case object Feedback extends EnquiryType {
    override val asString = "Feedback"
  }
  ...
  ): QueryStringBindable[EnquiryType] =
    new QueryStringBindable[EnquiryType] {
      override def bind(
          key: String,
          params: Map[String, Seq[String]]
      ): Option[Either[String, EnquiryType]] =
